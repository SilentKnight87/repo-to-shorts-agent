...
**Objective:** Make the repo's strategy match The intended positioning: Hermes is the harness, Kimi powers the harness, and Kimi also appears as a product-level critic/editor.
...
**Objective:** Let the operator override the model without editing code.
